const DEFAULT_NAME = "glub", DEFAULT_VERSION = "1.0.1", DEFAULT_DESCRIPTION = "Simple CMake setup for developing OpenGL programs in C++", DEFAULT_SRC_PATH = "src/", DEFAULT_RES_PATH = "res/";
...
let data = {}, projectInfo = { name: "", version: "", description: "", srcPath: "", resPath: "" }, useHttps = true;
